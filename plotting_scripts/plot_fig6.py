...
for het in range(num_het):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("case" + str(ERSAA_case_num[het]) + "_ersaa/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/ols/samp_" + str(ERSAA_samp_num[het][samp_size]+1) + "/ersaa_obj.txt") as ERSAA_ols_nohet_file:
...
for het in range(num_het):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("case" + str(ERSAA_case_num[het]) + "_ersaa/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/ols/samp_" + str(ERSAA_samp_num[het][samp_size]+1) + "/ersaa_obj.txt") as ERSAA_ols_het_file:
...
for het in range(num_het):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("case" + str(PP_case_num[het]) + "_pointpred/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/ols/samp_" + str(PP_samp_num[samp_size]+1) + "/pointpred_obj.txt") as PP_ols_file:
