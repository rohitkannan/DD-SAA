...
demand_data, ~ = generateDemandData(numCovariates,numDataSamples[sampSizeNum],degree[degNum],covariate_mean,covariate_covMat,coeff_true)
...
nsaaObjEstimates = estimateSolnQuality(z_soln_NSAA,covariate_obs,degree[degNum],numMCScenarios,numMCReplicates,coeff_true)
