# parameters for ER-SAA + kNN without heteroscedasticity estimation with d_x = 100 and omega = 1
...
# regression method
const regressionMethod = "kNN"

# determine number of samples depending on the number of covariates
const numDataSamples = Int64[152,202,505,2020,10100]
