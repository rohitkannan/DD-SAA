...
const fitQualityFile = "fit_quality.txt"
...
demand_scen_ersaa, fitQuality = generateERSAAScenarios(demand_data,covariate_data,covariate_obs,regressionMethod,coeff_true)
...
if(storeResults)
	...
	if(degree[degNum] == 1)
		fit_quality_file = subDirName2 * fitQualityFile
