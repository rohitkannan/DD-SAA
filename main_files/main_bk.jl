...
#*========= MODEL INFORMATION ==========
const caseNum = 1
const paramsFile = "params_case" * string(caseNum) * "_bk.jl"
#*======================================
...
const baseDirName = "case" * string(caseNum) * "_bk/" * "mod_" * string(modRepNum) * "/" * "deg_" * string(degNum) * "/"
